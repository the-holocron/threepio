# Bundlewatch Config [![npm](https://img.shields.io/npm/v/@theholocron/bundlewatch-config?color=red)](https://www.npmjs.com/package/@theholocron/bundlewatch-config)

A [bundlewatch configuration](https://bundlewatch.io/#/reference/configuration) for monitoring file size for libraries in the Galaxy.
...
{
  "scripts": {
    "audit": "bundlewatch --config ./node_modules/@theholocron/bundlewatch-config/index.js",
  }
}
```
