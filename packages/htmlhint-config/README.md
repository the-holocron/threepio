# HTMLHint Config [![npm](https://img.shields.io/npm/v/@theholocron/htmlhint-config?color=red)](https://www.npmjs.com/package/@theholocron/htmlhint-config)

A [HTMLHint configuration](https://htmlhint.com/docs/user-guide/configuration) for writing well-formed HTML within the Galaxy.

## Installation

```bash
npm install --save-dev @theholocron/htmlhint-config
```
...
{
  "scripts": {
    "lint:html": "htmlhint --config ./node_modules/@theholocron/htmlhint-config/index.js src/**/*.html"
  }
}
```
