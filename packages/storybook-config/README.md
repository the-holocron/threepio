...
```bash
npm install --save @theholocron/storybook-config
```
...
{
  "scripts": {
    "docs": "build-storybook -c ./node_modules/@theholocron/storybook-config -o docs",
    "start": "start-storybook -c ./node_modules/@theholocron/storybook-config"
  }
}
```
